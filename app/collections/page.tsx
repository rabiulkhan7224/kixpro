...
const CollectionsPage = () => {
  const collections = [
    ...
    { id: 3, name: "Nike", slug: "nike", image: "/jorden.jpeg" },
    {
      ...
      name: "Asics",
      slug: "asics",
      image: "/air-jordan-3-retro-multi-camo-DO.webp",
    },
    ...
    },
    {
      ...
      name: "Jordan",
      slug: "jordan",
      image: "/air-jordan-4-retro-red.webp",
    },
    {
      id: 9,
      name: "Samuel Bailey",
      slug: "samuel-bailey",
      image: "/samuel-bailey.png",
    },
    { id: 10, name: "Yeezy", slug: "yeezy", image: "/yeezy.png" },
  ];

  return (
    <div className="max-w-350 mx-auto px-6 py-16 bg-white">
      {/* Page Header */}
      <div className="mb-12">
        ...
        {collections.map((item) => (
          <div key={item.id} className="group flex flex-col space-y-4">
            ...
            <Link
              ...
              className="relative aspect-square overflow-hidden rounded-sm bg-[#F5F5F3]"
            >
              <Image
                src={item.image}
                alt={item.name}
